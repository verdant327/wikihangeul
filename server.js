...
class Room {
  ...
  start() {
    const p1Rank = (typeof db.getUserRank === 'function') ? db.getUserRank(this.p1.id) : null;
    const p2Rank = (this.p2.isBot || typeof db.getUserRank !== 'function') ? null : db.getUserRank(this.p2.id);
